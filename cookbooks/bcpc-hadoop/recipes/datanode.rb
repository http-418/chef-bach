...
locking_resource 'hadoop-hdfs-datanode-restart' do
  ...
  [
   ...
   'template[/etc/hadoop/conf/hadoop-metrics2.properties]',
  ...
  ].each do |resource_qualified_name|
    subscribes :serialize, resource_qualified_name, :immediate
  end
end
